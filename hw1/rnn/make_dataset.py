...
def main(args):
    ...
    valid = preprocessor.get_dataset(config['valid_json_path'], args.n_workers,
                                     {'n_positive': 1, 'n_negative': 4, 'shuffle': False})
    ...
    test = preprocessor.get_dataset(config['test_json_path'], 
                                    args.n_workers, {'n_positive': -1, 'n_negative': -1, 'shuffle': False})
