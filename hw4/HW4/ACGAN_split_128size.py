...
class Discriminator(nn.Module):
    ...
    def __init__(self, hair_classes, eye_classes, face_classes, glasses_classes):
        ...
        self.glasses_classes = glasses_classes
        ...
        self.glasses_classifier = nn.Sequential(
            ...
            nn.BatchNorm1d(128),
            nn.LeakyReLU(0.2),
            nn.Linear(128, self.glasses_classes),
            nn.Softmax()
        )
    ...
    def forward(self, _input):
        ...
        face_class = self.face_classifier(flatten)
        glasses_class = self.glasses_classifier(flatten)
        return discrim_output, hair_class, eye_class, face_class, glasses_class


if __name__ == '__main__':
    latent_dim = 100
    hair_classes, eye_classes, face_classes, glasses_classes = 6, 4, 3, 2
    class_dim = hair_classes + eye_classes + face_classes + glasses_classes
    batch_size = 5
