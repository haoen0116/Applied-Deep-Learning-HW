...
from pytorch_pretrained_bert_change.file_utils import PYTORCH_PRETRAINED_BERT_CACHE
from pytorch_pretrained_bert_change.modeling import BertForSequenceClassification
from pytorch_pretrained_bert_change.tokenization import BertTokenizer
...
class MrpcProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        # cy: logger.info("LOOKING AT {}".format(os.path.join(data_dir, "train.tsv")))
